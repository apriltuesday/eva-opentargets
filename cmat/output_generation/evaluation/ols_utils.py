...
def fetch_eval_data(*, db_iden=None, uri=None, include_neighbors=False):
    ...
    is_obsolete = False
    synonyms = {OntologyUri.uri_to_curie(ontology_uri)}
    parents = {}
    children = {}
    ...
    if include_neighbors:
        return ontology_uri.curie, is_obsolete, synonyms, parents, children
    return ontology_uri.curie, is_obsolete, synonyms
