...
class TestGetOxoResultsFromResponse:
    def test_get_oxo_results_from_response(self):
        with requests_mock.mock() as m:
            ...
            m.get(
                "https://www.ebi.ac.uk/ols/api/ontologies/efo/terms/http%253A%252F%252Fwww.orpha.net%252FORDO%252FOrphanet_660",
                json={'message': 'Resource not found', 'timestamp': 1502441846181,
                      ...
                      'error': 'Not Found',
                      'path': '/ols/api/ontologies/efo/terms/http%253A%252F%252Fwww.orpha.net%252FORDO%252FOrphanet_660'},
                status_code=404)
