...
class TestGetOxoResultsFromResponse:
    def test_get_oxo_results_from_response(self):
        with requests_mock.mock() as m:
            m.get("https://www.ebi.ac.uk/ols4/api/terms?iri=http://www.orpha.net/ORDO/Orphanet_660",
                  json=test_oxo_data.TestGetOxoResultsFromResponseData.orphanet_660_ols_terms_json)

            m.get(
                "https://www.ebi.ac.uk/ols4/api/ontologies/efo/terms/http%253A%252F%252Fwww.orpha.net%252FORDO%252FOrphanet_660",
            ...
            m.get("https://www.ebi.ac.uk/ols4/api/terms?iri=http://www.orpha.net/ORDO/Orphanet_3164",
                  json=test_oxo_data.TestGetOxoResultsFromResponseData.orphanet_3164_ols_terms_json)

            m.get("https://www.ebi.ac.uk/ols4/api/ontologies/efo/terms/http%253A%252F%252Fwww.orpha.net%252FORDO%252FOrphanet_3164",
                  json=test_oxo_data.TestGetOxoResultsFromResponseData.orphanet_3164_ols_efo_json)

            m.get("https://www.ebi.ac.uk/ols4/api/terms?iri=http://purl.obolibrary.org/obo/HP_0001537",
